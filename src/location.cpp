...
void rotate(Mat &srcimg, Mat &dstimg)
{
	...
	if (flag == true)
	{
		...
		case 1:point4.x = point2.x + point3.x - point1.x; point4.y = point2.y + point3.y - point1.y; 
			line(srcimg, point1, point4, Scalar(125), 8);
			line(srcimg, point2, point3, Scalar(125), 8);


			break;
		case 2:point4.x = point1.x + point3.x - point2.x; point4.y = point1.y + point3.y - point2.y; 
			line(srcimg, point2, point4, Scalar(125), 8);
			line(srcimg, point1, point3, Scalar(125), 8);
			break;
		case 3:point4.x = point1.x + point2.x - point3.x; point4.y = point1.y + point2.y - point2.y; 
			line(srcimg, point3, point4, Scalar(125), 8);
			line(srcimg, point1, point2, Scalar(125), 8);
			break;
		}
